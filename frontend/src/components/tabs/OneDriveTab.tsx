...
export default function OneDriveTab() {
    ...
    // Collapsible state for file browser
    ...
    const [mappingDescription, setMappingDescription] = useState('');  // For generating new transform
                                            ...
                                            {files.map((file, index) => (
                                                ...
                                                >
                                                    <Button
                                                        ...
                                                        className={cn(
                                                            "w-full h-auto p-3 justify-start items-start text-left font-normal hover:bg-accent hover:text-accent-foreground",
                                                    ...
                                                    >
                                                        <div className="w-full">
                                                            <div className="font-medium text-foreground break-words whitespace-normal pr-2">
                                                                {file.name}
                                                            </div>
                                                            <div className="text-sm opacity-70 flex justify-between mt-1">
                                                                <span className="break-all whitespace-normal mr-2">{file.path}</span>
